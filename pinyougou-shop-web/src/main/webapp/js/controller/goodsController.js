...
app.controller('goodsController', function($scope, $controller, $location,
		goodsService, itemCatService, uploadService, typeTemplateService) {
		...
		typeTemplateService.findOne(newValue).success(
				function(response) {
					...
					if($location.search()['id']==null){
						$scope.entity.goodsDesc.customAttributeItems = JSON.parse($scope.typeTemplate.customAttributeItems);// 拓展属性
					}
				});
		// 查询规格列表
	...
	$scope.status = [ '未审核', '审核通过', '审核未通过', '已驳回' ];// 商品状态
