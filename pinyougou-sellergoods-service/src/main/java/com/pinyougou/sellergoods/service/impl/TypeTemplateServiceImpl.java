...
public class TypeTemplateServiceImpl implements TypeTemplateService {
	...
	private void saveToRedis() {
		...
		for (TbTypeTemplate typeTemplate : typeTemplateList) {
			...
			redisTemplate.boundHashOps("brandList").put(typeTemplateId,
					brandList);
			// 存储规格列表
			List<Map> specList = findSpecList(typeTemplateId);// 根据模板ID查询规格列表
			redisTemplate.boundHashOps("specList").put(typeTemplateId,
					specList);
		}
	}
